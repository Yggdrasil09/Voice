...
import ParallelText from "../Text/ParallelText";
import "./Listen.css";

class ListenParallel extends Component {
  constructor() {
    super();
    this.state = {
      sound: false,
      ...
      <Container className="max-border">
        ...
        <Row>
          ...
          <Col md={9} className="display">
            ...
            <ParallelText text={this.state.text[this.state.taskno][0]} />      
          </Col>
          <Col md={2}>
...
export default connect(mapStateToProps)(ListenParallel);
